...
Задумка также была обыграть интерфейсы на примере FleetDisposable - AutoDisposer и MunualDisposer
авто и ручной расстановщик по-разному бы выполняли disposeFleet() интерфейса FleetDisposable
